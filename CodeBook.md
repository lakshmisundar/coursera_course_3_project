# Code Book
This code book is for the script "run_analysis.R"

## Steps to clean the data
* Downloading the dataset zip file ==> https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
* Extracting the zip file "USI HAR Dataset"
* Loading datasets of activity and label names
* Loading datasets of training and test
* Mapping column names with appropriate labels
* Merging the test & train datasets
* Creating a pretty dataset by retrieving only mean and std.dev.
* Converting the pretty dataset as a text file (pretty_data.txt)

> Pretty Data after clean-up
